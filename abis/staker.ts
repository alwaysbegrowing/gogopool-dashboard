export const stakerAbi = [
  ...
  { inputs: [], name: "GGPLocked", type: "error" },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint256", name: "ggpStaked", type: "uint256" },
          {
            internalType: "uint256",
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "stakerAddr", type: "address" },
      { internalType: "uint256", name: "ggpAmt", type: "uint256" },
    ],
    name: "slashGGP",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "stakerAddr", type: "address" },
      { internalType: "uint256", name: "amount", type: "uint256" },
      { internalType: "uint256", name: "ggpLockedUntil", type: "uint256" },
    ],
