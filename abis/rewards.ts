export const rewardsAbi = [
  ...
  { inputs: [], name: "ContractHasNotBeenInitialized", type: "error" },
  { inputs: [], name: "ContractNotFound", type: "error" },
  { inputs: [], name: "ContractPaused", type: "error" },
  { inputs: [], name: "IncorrectRewardsDistribution", type: "error" },
  { inputs: [], name: "InvalidOrOutdatedContract", type: "error" },
  { inputs: [], name: "MaximumTokensReached", type: "error" },
  ...
  { inputs: [], name: "UnableToStartRewardsCycle", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  {
    inputs: [
      { internalType: "string", name: "claimingContract", type: "string" },
    ],
